...
- Fixed issue with initializtion of trezor connect iframe with previous connected trezor accounts ([#13018](https://github.com/MetaMask/metamask-extension/pull/13018))
